...
If something isn't checked, that means I haven't yet figured out a "best practice" way to implement it. However, if you're knowledgeable in the language, a PR would be much appreciated.
